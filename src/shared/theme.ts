...
export const theme = {
  colors: { background: '#EEF2F7', surface: '#F9FBFE', surfaceAlt: '#E9EEF5', text: '#101522', muted: '#667085', border: 'rgba(16,24,40,0.09)', primary: '#162033', gold: '#D4A72C', success: '#08734B', successSoft: '#DDF4EA', danger: '#B42318', dangerSoft: '#FBE3E3', info: '#3D6FD8', infoSoft: '#E1E9FA', white: '#FFFFFF', overlay: 'rgba(16,21,34,0.32)' },
